...
7. Offline run after models are installed
8. Confirm no external network during record → insert
9. `npm run license:check`
10. `npm run build:release` (SBOM + SHA256SUMS + `.app` / `.dmg`)
11. Fill `docs/evaluation/MVP_SCORECARD.md` from measured results
